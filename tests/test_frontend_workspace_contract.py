...
def test_workspace_uses_allowlisted_segments_and_versioned_local_assets():
    ...
    assert "/assets/styles.css?v=task-188-1" in html
    assert "/assets/app.js?v=task-188-1" in html
    assert "/assets/editing.js?v=task-188-1" in html
    assert "Build task-188-1" in html
